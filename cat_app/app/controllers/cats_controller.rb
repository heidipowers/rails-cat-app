class CatsController < ApplicationController
  def index
    getCats = {}
    getCats[:pic] = HTTParty.get("http://thecatapi.com/api/images/get?format=xml&results_per_page=1&size=med")
    getCats[:fact] = JSON.parse(HTTParty.get("http://catfacts-api.appspot.com/api/facts?number=1"))
